...
| **Enterprise Features** | RBAC, Audit Trails (HMAC + Durable Store) | SSO, RBAC, Data Retention | SSO, RBAC |
| **Export Adapters** | **Available (OTLP, Console, etc.)** | High (native + exports) | High |
