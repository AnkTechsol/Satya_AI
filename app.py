...
# ─── ROI DASHBOARD ─────────────────────────────────────
    ...
    # ⚡ Bolt Optimization:
    # `all_tasks` is already globally evaluated on line 651 via `tasks_manager.list_all()`.
    # Reusing the existing list prevents redundant file I/O operations and speeds up page load.
