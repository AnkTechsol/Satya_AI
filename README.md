...
## Repository Status
- **Last Analytics Run:** 2026-07-08T15:13:13.333120+00:00Z
- **Open Issues:** Unknown
- **Recent CI Status:** failing
...
- **Export Adapter Framework (OTLP/Console/LangSmith)** (Added 2024-03)
  ...
  - Runbook: Pass a list of instantiated adapters to `satya.init(adapters=[OTLPAdapter(), LangSmithAdapter(api_key="...")])`.
  - Validation: `PYTHONPATH=. pytest tests/test_adapters.py` and `pytest tests/test_langsmith_adapter.py`
