...
## Repository Status
- **Last Analytics Run:** 2026-07-18T14:59:17.817533+00:00Z
- **Open Issues:** Unknown
...
- **Task Export API (CSV/JSONL Exporter)**: Added on July 2026. A lightweight exporter that aggregates all flat-file tasks into a single analytical payload.
  - *Validation command:* `pytest tests/test_export.py`
  - *Runbook:* Use `satya.core.export.export_tasks_to_jsonl(output_path)` to generate enterprise reporting feeds.
