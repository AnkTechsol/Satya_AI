...
## Repository Status
- **Last Analytics Run:** 2026-08-31T15:17:07.271332+00:00Z
- **Open Issues:** Unknown
...
- **Webhook Export Adapter**: Added on August 2026. Streams traces and logs to external systems via Webhooks. It uses a background thread and bounded queues to safely swallow errors without crashing the main application loop.
  - *Validation command:* `pytest tests/test_webhook_adapter.py`
  - *Runbook:* Initialize `SatyaClient(adapters=[WebhookAdapter()])`.
