...
## Repository Status
- **Last Analytics Run:** 2026-07-05T14:52:53.690655+00:00Z
- **Open Issues:** Unknown
...
- **Export Adapter Framework (OTLP/LangSmith)**: Added on April 2026. A small, modular adapter system that enables Satya to export traces/events to LangSmith or OTLP. It keeps the core lightweight while letting enterprises reuse existing investments.
  - *Validation command:* `python -m pytest tests/test_adapters.py`
