...
## Repository Status
- **Last Analytics Run:** 2026-08-14T14:45:06.932913+00:00Z
- **Open Issues:** Unknown
...
- **Webhook Export Adapter**: Added on August 2026. Exports traces and logs via HTTP webhooks, ensuring SSRF mitigations for enterprise security environments.
  - *Validation command:* `pytest tests/test_webhook_adapter.py`
  - *Runbook:* Initialize `SatyaClient(adapters=[WebhookExportAdapter(url="...", auth_token="...")])`.
