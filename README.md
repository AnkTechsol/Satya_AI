...
## Repository Status
- **Last Analytics Run:** 2026-08-02T15:06:32.777402+00:00Z
- **Open Issues:** Unknown
...
- **CSV/JSONL Export Adapter**: Added on 2026-08-02. A local export adapter that enables Satya to export traces/events to a local CSV or JSONL file.
  - *Validation command:* `pytest tests/test_file_adapter.py`
  - *Runbook:* Initialize `SatyaClient(adapters=[CSVJSONLExportAdapter(filepath="traces.jsonl", format="jsonl")])`.
