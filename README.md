...
- **Enterprise ROI Dashboard** (Added 2026-03)
  - Quantifies the business value of autonomous execution vs manual labor by tracking token usage, velocity, and computing ROI cost savings.
  - Runbook: Navigate to the "ROI Dashboard" page in the Streamlit UI.
  - Validation: Ensure the "ROI Dashboard" option is available in the sidebar and displays the calculated metrics.
