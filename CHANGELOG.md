...
## [Unreleased]
- [2026-05-24] **Added:** LangSmith Export Adapter for exporting trace events directly to LangSmith from the agent runtime without core codebase rewrites. (Risk: Low)
