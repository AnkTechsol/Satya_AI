...
## [Unreleased]
- [2026-06-07] **Added:** LangSmith and File export adapters (`satya.sdk.adapters.langsmith`, `satya.sdk.adapters.file`). Provides deep trace analytics export to LangSmith and fallback file persistence. (Risk: Low)
