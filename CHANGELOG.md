...
## [Unreleased]
- [2026-09-26] **Added:** DatadogAdapter for enterprise observability streaming to Datadog. Includes a background worker thread for non-blocking exports. (Risk: Low)
