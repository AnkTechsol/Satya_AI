...
## [Unreleased]
- [2026-05-13] **Added:** Lightweight exportable trace format & schema (`src/satya/core/schema.py`) to standardize event logging for Export Adapters (OTLP/Langfuse). (Risk: Low, standardizes data structure)
- [2026-05-13] **Updated:** Ran automated analytics generation, producing `repo_analytics.json` and `REPO_ANALYTICS.md`.
