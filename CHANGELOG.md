...
### Added
- Implemented **Durable append-only audit store (SQLite fallback)** to store events persistently into `satya_data/events/audit_log.db` alongside `audit_log.jsonl`.
