...
- [2026-08-01] **Added:** Added missing test coverage for export adapters (OTLP, Langfuse, LangSmith) in `tests/test_sdk_adapters.py`. Consolidated SUSTAINABLE_FEATURES blocks in README.md. (Risk: Low)
