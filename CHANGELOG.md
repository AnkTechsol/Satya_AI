...
## [Unreleased]
- [2026-09-23] **Added:** Datadog Export Adapter for asynchronous streaming of traces and logs to Datadog API. (Risk: Low)
- [2026-09-23] **Added:** Generated new analytics via jules/analytics snapshot. Updated `repo_analytics.json`, `REPO_ANALYTICS.md` and `README.md`. (Risk: Low)
