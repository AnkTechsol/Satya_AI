...
## [Unreleased]
- [2026-06-08] **Added:** LangSmith Export Adapter (`satya.sdk.adapters.langsmith`) to support telemetry streaming to LangSmith. (Risk: Low, uses existing Adapter framework)
