...
### Added
- Implemented **Durable Append-Only Audit Store** with SQLite implementation to safely store task transitions and audit trails, supporting a `SATYA_USE_AUDIT_DB` toggle.
